...
class FacebookCapi
{
    ...
    {
        $this->pixelId     = config('services.facebook_capi.pixel_id');
        $this->accessToken = config('services.facebook_capi.access_token');
        $this->currency    = config('services.facebook_capi.currency', 'PHP');
    }
