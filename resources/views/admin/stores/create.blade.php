                ...
                <section>
                    ...
                    <div class="tflex tpx-5 ">
                        <div class="tw-1/4 tflex tflex-col tmr-3">
                            ...
                            <select name="platform" id="platform" class="browser-default form-control"  style="padding: 6px;">
                    ...
                    <div class="tflex tpx-5 tmt-5">
                        <div class="tw-1/2 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="store_name" id="store_name" value="{{ old('store_name') }}" class="browser-default form-control" style="padding: 6px;">
                            @error('store_name')
                                <div class="ttext-red-600 tfont-bold ttext-sm">{{ $message }}</div>
                            @enderror
                        </div><!-- Store Name -->
                        <div class="tw-1/2 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="username" id="username" value="{{ old('username') }}" class="browser-default form-control" style="padding: 6px;">
                            @error('username')
                                <div class="ttext-red-600 tfont-bold ttext-sm">{{ $message }}</div>
                            @enderror
                        </div><!-- Username -->
