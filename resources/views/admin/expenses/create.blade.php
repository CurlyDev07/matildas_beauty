                ...
                <section>
                    <div class="tflex tpx-5 tmt-5">
                        ...
                        <div class="tw-1/5 tflex tflex-col tmr-3">
                            ...
                            <input type="number" name="cost" id="cost" value="{{ old('cost') }}" class="browser-default form-control" style="padding: 6px;" required>
                            @error('cost')
                                <div class="ttext-red-600 tfont-bold ttext-sm">{{ $message }}</div>
                            @enderror
                        </div><!-- COST -->
                    ...
                    <div class="tflex tpx-5 tmt-2 tflex tflex-row">
                        <textarea required placeholder="Notes about the transaction" name="Notes" id="Notes" cols="30" rows="3" class="browser-default form-control tmt-2" style="padding: 6px;" spellcheck="false"></textarea>
                    </div>
