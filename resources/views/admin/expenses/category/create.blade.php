                ...
                <section>
                    ...
                    <div class="tflex tpx-5 ">
                        <div class="tw-1/3 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="social_media" id="social_media" value="{{ old('social_media') }}" class="browser-default form-control" style="padding: 6px;">
                            @error('social_media')
                                <div class="ttext-red-600 tfont-bold ttext-sm">{{ $message }}</div>
                            @enderror
                        </div><!-- FB LINK -->
                        <div class="tw-2/3 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="social_media_link" id="social_media_link" value="{{ old('social_media_link') }}" class="browser-default form-control" style="padding: 6px;">
                ...
                <section>
                    ...
                    <div class="tflex tpx-5 ">
                        ...
                        <div class="tw-1/2 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number') }}" class="browser-default form-control" style="padding: 6px;">
                    ...
                    <div class="tflex tpx-5 tmt-5">
                        <div class="tw-1/2 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="account_name" id="account_name" value="{{ old('account_name') }}" class="browser-default form-control" style="padding: 6px;">
                            @error('account_name')
                                <div class="ttext-red-600 tfont-bold ttext-sm">{{ $message }}</div>
                            @enderror
                        </div><!-- Account Name -->
                        <div class="tw-1/2 tflex tflex-col tmr-3">
                            ...
                            <input type="text" name="account_number" id="account_number" value="{{ old('account_number') }}" class="browser-default form-control" style="padding: 6px;">
