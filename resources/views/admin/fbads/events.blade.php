            ...
            <ul class="tflex titems-center">
                <li class="tmr-4">
                    <form action="{{ route('fbads.events') }}" class="tflex titems-center">
                        <input type="text" name="search" id="barcode" value="" class="tw-64 browser-default tborder-b tborder-gray-200 tborder-l tborder-t toutline-none tpx-3 tpy-2 trounded-bl trounded-tl" placeholder="Search CP# | Name | Address">
