                ...
                <div id="products_container" class="tw-3/5 tborder-l tpl-2 toverflow-scroll toverflow-x-hidden tpr-6" style="height: 450px">
                    ...
                    @foreach ($orders->products as $order)
                        ...
                        <div class="product tborder-b tflex tmx-1 trelative tpy-1" id="{{ $order->product->id }}" prev_qty="{{ $order->qty }}">
                            ...
                            <div class="tw-1/6 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Price</label>
                                <input type="text" onkeyup="allnumeric(this)" value="{{ $order->price }}" class="product_price browser-default form-control cursor: not-allowed;" style="padding: 6px;">
                            </div><!-- Price -->
                            <div class="tw-1/6 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Quantity</label>
                                <input type="number" onkeyup="allnumeric(this)" value="{{ $order->qty }}" class="product_quantity browser-default form-control" style="padding: 6px;">
                            </div><!-- QTY -->
                            <div class="tw-1/6 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Subtotal</label>
                                <input type="text" onkeyup="allnumeric(this)" disabled="" value="{{ $order->subtotal }}" class="product_subtotal tcursor-pointer browser-default form-control" style="padding: 6px;background: #f9f9f9; cursor: not-allowed;">
                            </div><!-- Sub Total -->
                            <i class="closeItem hover:tunderline material-icons t-mr-4 tabsolute tcursor-pointer tmt-6 tright-0 ttext-error">close</i>
                        </div>
                    @endforeach
