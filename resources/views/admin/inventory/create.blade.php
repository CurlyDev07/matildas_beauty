    ...
    <div class="tbg-white  trounded-lg tshadow-lg ttext-black-100">
        <div class="tflex tjustify-between tborder-b ">
            ...
            <div class="tflex titems-center tjustify-end tmx-5 tpr-3 tpy-3">
                <div class="tpx-6" ><span id="total_items" style="font-size: 24px;">0</span> <small> Item(s)</small></div>
            </div>
        </div>
        ...
        <div class="tbg-white tpb-5 trounded-lg tshadow-lg ttext-black-100 tmt-3 tp-4">
            <textarea name="note" id="note" cols="30" rows="3" class=" browser-default form-control" style="padding: 6px;">Notes</textarea>
        </div>
    </div><!-- Create Order -->
...
@section('js')
    ...
    <script>
        ...
        $('#submit_btn').click(()=>{
            ...
            $.post( "/admin/inventory/stock-in/store", {
                'products': products,
