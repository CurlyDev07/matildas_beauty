    ...
    <div class="tbg-white  trounded-lg tshadow-lg ttext-black-100">
        ...
        <div class="tflex tpx-5">
            <div class="tw-2/5 tmr-2">
                ...
                <input type="text" value="{{ $production->product_name }}" class="product_name tcursor-pointer browser-default form-control">
            </div><!-- Product Name -->
            <div class="tw-2/5 tmr-2">
                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100">Batch Weight </label>
                <input type="text" value="{{ $production->total_weight }}" class="total_weight tcursor-pointer browser-default form-control">
            </div><!-- Total Weight -->
            <div class="tw-2/5 tmr-2">
             ...
             <div class="tw-2/5 tmr-3">
                ...
                <input type="text" class="datepicker browser-default form-control" value="{{ $production->date }}">
            </div><!-- Date -->
        </div>
        ...
        <div class="tbg-white tpb-5 trounded-lg tshadow-lg ttext-black-100 tmt-3">
                ...
                <div id="products_container" class="tw-3/5 tborder-l tpl-2 toverflow-scroll toverflow-x-hidden tpr-6" style="height: 450px">
                    ...
                    @foreach ($production->ingredients as $ingredient)
                        <div class="product tborder-b tflex tmx-1 trelative tpy-1" id="{{ $ingredient->ingredient_id }}">
                            ...
                            <div class="tw-1/3 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Percentage</label>
                                <input type="number" value="{{ $ingredient->product_percentage }}" class="product_percentage browser-default form-control" style="padding: 6px;">
                            </div><!-- Percentage -->
                            <div class="tw-1/3 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Grams</label>
                                <input type="number" value="{{ $ingredient->grams }}" class="grams browser-default form-control" style="padding: 6px; background-color: #b0b0b02b;" readonly>
                            </div><!-- Grams -->
                              <div class="tw-1/3 tflex tflex-col tmr-3">
                                <label class="tfont-normal ttext-sm tmb-2 ttext-black-100 active">Price</label>
                                <input type="number" value="{{ $ingredient->price }}" class="price browser-default form-control" style="padding: 6px; background-color: #b0b0b02b;" readonly>
                            </div><!-- Price -->
            ...
            <div class="tpx-5 tmt-5">
                <textarea id="comment" cols="1" rows="5" 
                    ...
                    placeholder="Enter your message here...">{{ $production->comment }}</textarea>
            </div>
