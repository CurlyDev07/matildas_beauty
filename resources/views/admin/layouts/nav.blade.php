    ...
    <div class="tcontainer">
        <div class="col s12">
            <ul class="tabs tabs tflex tjustify-between">
                ...
                <li class="tab col">
                    <a href="#" class="{{ is_matched_return_class(admin_parent_nav(), 'stores', 'active') }}" onclick="location.href = '/admin/stores'">
                        <i class="fas fa-users tmr-1 fa-lg"></i> 
                        Stores
                    </a>
                </li>
                <li class="tab col">
                    <a href="#" class="{{ is_matched_return_class(admin_parent_nav(), 'store-metrics', 'active') }}" onclick="location.href = '/admin/store-metrics'">
                        <i class="fas fa-users tmr-1 fa-lg"></i> 
                        Store Metrics
                    </a>
                </li>
