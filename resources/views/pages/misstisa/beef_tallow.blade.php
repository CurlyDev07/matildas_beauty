<?php
    ...
    $products = [
        [
            ...
            'promo_text_1' => '25g  Beef Tallow Balm',
            'promo_text_2' => 'Moisture • Repair • Glow',
            'stock' => '38',
        ],
        [
            'id' => 1,
            ...
            'promo_text_1' => '2pcs Beef Tallow Balm',
            'promo_text_2' => '⭐ Good for 1 Month',
            'stock' => '8',
        ],
        [
            'id' => 2,
            'name' => 'Buy 2 Take 2 Beef Tallow',
            'price' => 999,
            'image' => 'https://matildasbeauty.com/filemanager/4e03fa345b604e8cbcf33e5c36930eb6.png',
            'description' => 'Complete beauty set with serum and lotion',
            'promo_text_1' => 'Best Value Beef Tallow',
            'promo_text_2' => '🔥 4pcs All-in Glow',
            'stock' => '3',
        ]
    ];
...
<body>
    <div style="scroll-behavior: smooth;max-width: 480px;" class="tmx-auto" id="body">
        <div class="tflex tfont-medium titems-center tjustify-center trelative tshadow-md ttext-center" style="height: 31px; background: linear-gradient(180deg,rgba(107, 37, 6, 1) 0%, rgba(206, 140, 77, 1) 100%);;">
            <div >
                {{-- <div class="">
        ...
        <img src="https://matildasbeauty.com/filemanager/45d6be9abf8f4d2b94af66500cbc6a87.webp" width="480" height="480" class="tw-full" alt="BUY 1 take 1">

        <div class="tfont-semibold ttext-center ttext-white tp-2 ttext-lg" style="background: linear-gradient(180deg,rgba(202, 136, 74, 1) 0%, rgba(107, 37, 6, 1) 79%);
">
        ...
        <h2 class="tpy-5 ttext-center ttext-[22px] tfont-semibold ttext-[#4a2c1a] tleading-tight">
        Why thousands are switching to
        Whipped Beef Tallow
        </h2>

        <div class="tflex tw-full tflex-wrap tjustify-left tpy-3 tpx-3 tmb-3">

            <div class=""><i class="fas fa-check-circle tmb-2" style="color: #ff4c00;"></i><b> Skin reset in one swipe.</b></div>
            <div class=""><i class="fas fa-check-circle tmb-2" style="color: #ff4c00;"></i><b> Looks unreal. Feels even better.</b></div>
            <div class=""><i class="fas fa-check-circle tmb-2" style="color: #ff4c00;"></i><b> Glow so good it looks fake.</b></div>
            <div class=""><i class="fas fa-check-circle tmb-2" style="color: #ff4c00;"></i><b> Dry skin? Completely erased.</b></div>
            <div class=""><i class="fas fa-check-circle tmb-2" style="color: #ff4c00;"></i><b> Youthful glow on contact.</b></div>
        ...
        <!-- SECTION 3: Texture / Visual Proof -->
        <section class="tw-full">
            <div class="tmx-auto tmax-w-[480px] tpx-4 tmt-5">

                <!-- Image Placeholder -->
                <!-- Replace this div with <img /> when ready -->
                <img src="https://matildasbeauty.com/filemanager/73ee85a5593e40fcb89e69059072db59.webp" width="480" height="480" class="tw-full" alt="Tallow Nourishment">

                <h3 class="tmt-6 ttext-center ttext-[20px] tfont-semibold ttext-[#4a2c1a]">
                This is what real nourishment looks like
                </h3>

                <p class="tmt-3 ttext-center ttext-[14px] ttext-[#6b4a2f]">
                Rich, whipped texture that melts into skin —<br>
                no sticky finish.
                </p>
        ...
        <section class="tw-full tmt-8">
            <div class="tmx-auto tmax-w-[480px] tpx-4 tpy-8">
                <h3 class="ttext-center ttext-[20px] tmb-5 tfont-semibold ttext-[#4a2c1a]">
                Real people. Real results.
                </h3>

                <img src="https://matildasbeauty.com/filemanager/d779bad9ac0d4d3a8dbb1d63745d206c.webp" width="480" height="480" class="tw-full" alt="BUY 1 take 1">
                <img src="https://matildasbeauty.com/filemanager/19174e9836ca4caa92ac9df14eccd4ab.webp" width="480" height="480" class="tw-full" alt="BUY 1 take 1">
                <img src="https://matildasbeauty.com/filemanager/8f8f41a9aac64e108a3860e9a83f3c50.webp" width="480" height="480" class="tw-full" alt="BUY 1 take 1">
            </div>
        </section>


        <!-- SECTION 6: Why It Works (Ingredients Trust) - WHITE ONLY -->
        <section class="tw-full tbg-white">
        <div class="tmx-auto tmax-w-[480px] tpx-4 tpy-10">

            <!-- Header -->
            <div class="ttext-center">
            <h3 class="ttext-[22px] tfont-semibold" style="color: #571c02;">
                Why It Works
            </h3>
            <p class="tmt-2 ttext-[14px] ttext-neutral-600">
                Simple ingredients that help support a soft, healthy-looking glow.
            </p>
            </div>

            <!-- Ingredient cards -->
            <div class="tmt-7 tspace-y-4">

            <!-- Beef Tallow -->
            <div class="trounded-2xl tborder tborder-neutral-200 tbg-white tp-4">
                <div class="tflex titems-center tgap-3">
                <div class="tshrink-0 th-20 tw-20 trounded-xl tborder tborder-neutral-200 tbg-white tflex titems-center tjustify-center">
                    <span class="ttext-4xl">🥛</span>
                </div>
                <div class="tmin-w-0">
                    <div class="ttext-[16px] tfont-semibold" style="color: #571c02;">Beef Tallow</div>
                    <p class="tmt-1 ttext-[14px] ttext-neutral-600 tleading-relaxed">
                    Rich in skin-loving fats that help support the moisture barrier and reduce the “dry tight” feeling.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="trounded-2xl tborder tborder-neutral-200 tbg-white tp-4">
                ...
                <div class="tmin-w-0">
                    <div class="ttext-[16px] tfont-semibold" style="color: #571c02;">Honey</div>
                    <p class="tmt-1 ttext-[14px] ttext-neutral-600 tleading-relaxed">
                    Helps keep skin feeling moisturized and comfortable—perfect for dry, dull-looking skin.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="trounded-2xl tborder tborder-neutral-200 tbg-white tp-4">
                ...
                <div class="tmin-w-0">
                    <div class="ttext-[16px] tfont-semibold" style="color: #571c02;">Olive Oil</div>
                    <p class="tmt-1 ttext-[14px] ttext-neutral-600 tleading-relaxed">
                    Softens rough patches and improves skin feel, leaving a smooth finish without heaviness.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="tmt-8 tgrid tgrid-cols-3 tgap-2">
            <div class="trounded-xl tborder tborder-neutral-200 tbg-white tpx-2 tpy-3 ttext-center">
                <div class="ttext-[12px] tfont-semibold" style="color: #571c02;">Face & Body</div>
                <div class="tmt-1 ttext-[11px] ttext-neutral-600">One balm for both</div>
            </div>
            <div class="trounded-xl tborder tborder-neutral-200 tbg-white tpx-2 tpy-3 ttext-center">
                <div class="ttext-[12px] tfont-semibold" style="color: #571c02;">Non-sticky</div>
                <div class="tmt-1 ttext-[11px] ttext-neutral-600">Comfort finish</div>
            </div>
            <div class="trounded-xl tborder tborder-neutral-200 tbg-white tpx-2 tpy-3 ttext-center">
                <div class="ttext-[12px] tfont-semibold" style="color: #571c02;">Daily Use</div>
                <div class="tmt-1 ttext-[11px] ttext-neutral-600">AM or PM</div>
            </div>
            </div>
        ...
        <img src="https://matildasbeauty.com/filemanager/57daca5f7fb544dcba522902c1ec5e4e.webp" width="480" class="tw-full" alt="BUY 1 take 1">
        <img src="https://matildasbeauty.com/filemanager/b544757a243643d6bd89ececb2912eb8.webp" width="480" class="tw-full" alt="BUY 1 take 1">

        <img src="https://matildasbeauty.com/filemanager/a796e59f8a514a148bf147e66d36db90.webp"  class="tw-full tmx-auto" alt="BUY 1 take 1">

        
        <!-- SECTION 7: How To Use (Simple, Premium) -->
        <section class="tw-full tbg-white">
        <div class="tmx-auto tmax-w-[480px] tpx-5 tpy-12">

            <!-- Header -->
            <div class="ttext-center">
            <h3 class="ttext-[24px] tfont-semibold ttext-[#571c02]">
                How to Use
            </h3>
            <p class="tmt-2 ttext-[14px] ttext-neutral-600">
                Simple steps. A little goes a long way.
            </p>
            </div>

            <!-- Timeline -->
            <div class="tmt-10 trelative tspace-y-10">

            <!-- Vertical line -->
            <div class="tabsolute tleft-[18px] ttop-0 tbottom-0 tw-[2px] tbg-[#571c02]/20"></div>

            <!-- Step 1 -->
            <div class="trelative tflex tgap-4">
                <div class="tshrink-0 th-9 tw-9 trounded-full tbg-[#571c02] ttext-white tflex titems-center tjustify-center tfont-semibold">
                1
                </div>
                <div>
                <div class="ttext-[16px] tfont-semibold ttext-neutral-900">
                    Scoop a pea-sized amount
                </div>
                <p class="tmt-1 ttext-[14px] ttext-neutral-600">
                    Warm it between fingertips until it melts.
                </p>
                </div>
            </div>
            ...
            <div class="trelative tflex tgap-4">
                ...
                <p class="tmt-1 ttext-[14px] ttext-neutral-600">
                    Face, neck, elbows, knees, hands—anywhere that needs moisture.
                </p>
                </div>
            </div>
            ...
            <div class="trelative tflex tgap-4">
                ...
                <p class="tmt-1 ttext-[14px] ttext-neutral-600">
                    Use upward strokes. Let it absorb before sunscreen or makeup.
                </p>
                </div>
            </div>
            ...
            <!-- Best for -->
            <div class="tmt-12">
            <div class="ttext-[15px] tfont-semibold ttext-[#571c02] ttext-center">
                Best for
            </div>

            <div class="tmt-4 tflex tflex-wrap tjustify-center tgap-2">
                <span class="trounded-full tborder tborder-[#571c02]/30 tpx-4 tpy-1 ttext-[13px] ttext-[#571c02]">
                Dry skin
                </span>
                <span class="trounded-full tborder tborder-[#571c02]/30 tpx-4 tpy-1 ttext-[13px] ttext-[#571c02]">
                Dull-looking skin
            ...
            <p class="tmt-4 ttext-center ttext-[13px] ttext-neutral-600">
                Tip: For oily skin, use a very small amount and apply only where needed.
            </p>
            </div>
        ...
        <div class="tmx-auto trelative tborder tpb-5">
            ...
            <section class="tflex titems-baseline tmt-5 tmb-3">
                <div class="ttext-center">
                    <i class="fas fa-truck ttext-4xl" style="color: #801b00; line-height: 1.2;"></i>
                    <span class="tinline-block tmt-1">Fast delivery nationwide</span>
                </div>
                <div class="ttext-center">
                    <i class="fas fa-dollar-sign ttext-4xl" style="color: #801b00; line-height: 1.2;" ></i>
                    <span class="tinline-block tmt-1">Moneyback Guarantee</span>
                </div>
                <div class="ttext-center">
                    <i class="fas fa-hand-holding-usd ttext-4xl" style="color: #801b00; line-height: 1.2;" ></i>
                    <span class="tinline-block tmt-1">Cash on Delivery</span>
                </div>
                <div class="ttext-center">
                    <i class="fas fa-headset ttext-4xl" style="color: #801b00; line-height: 1.2;"></i>
           ...
           {{-- <div class="tbg-yellow-300 tborder-2 tborder-red-500 tfont-medium tmb-2 tmt-5 tmx-4 trounded ttext-center ttext-red-700">
            ...
            {{-- <form action="{{ route('miss_tisa_submit') }}" id="form" class="relative" method="post" enctype="multipart/form-data">
                ...
                <div class="th-full tflex tflex-col tmax-w-2xl tmx-auto tbg-white tp-3">
                    ...
                    <div class="tflex tflex-col">
                        <h2 class="ttext-center ttext-base tfont-bold ttext-gray-800 tmb-2">
                            <span class="ttext-lg">🌟</span> Beef Tallow Beauty Collection
                        </h2>

                        <div class="tborder-dashed ttext-center tmy-2 tpy-1" style="border: 2px solid #742e03ff; border-style: dashed; display: none;">
                            <span class="tfont-bold  ttext-center" style="font-size: 20px;"><i class="fas fa-gift ttext-3xl" style="color: red"></i> New Year Promo – Ends Soon! <i class="fas fa-gift ttext-3xl" style="color: red"></i></span>
                ...
                {{-- <div class="tw-full ">
                    <button style="background-color: #742e03ff" class="focus:tbg-pink-500 trelative tshadow tfont-medium tmt-4 tpy-3 trounded-full ttext-2xl ttext-white tw-full waves-effect z-depth-5" id="submit_btn">
                        <span>Checkout Order</span>
                    </button>
                    <span style="background-color: #742e03ff" class="thidden focus:tbg-pink-500 trelative ttext-center tshadow tfont-medium tmt-4 tpy-3 trounded-full ttext-2xl ttext-white tw-full waves-effect z-depth-5" id="loader">
            ...
            <button class="order_now tabsolute  tbottom-0 tfixed tfont-medium tmb-5 tmt-4 tpy-3 trounded-full ttext-lg ttext-white tw-10/12 waves-effect zoom-in-out-box" 
                style="position: fixed; max-width: 480px; z-index: 999; opacity: 1; margin-left: auto; margin-right: auto; left: 0; right: 0;background-color: #742e03ff;">
                ORDER NOW!
            </button>
