...
<footer class="tw-full tw-bg-pink-100 tw-border-t tw-border-pink-200">
  <div class="tw-max-w-6xl tw-mx-auto tw-px-6 tw-py-10">
    
    <!-- Title -->
    <h2 class="ttext-center ttext-pink-700 ttext-xl tfont-semibold tw-mb-6">
      Contact Us
    </h2>

    <!-- Contact Info -->
    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-6 ttext-center">
      
      <!-- Email -->
      <div>
        <p class="tfont-medium ttext-pink-600">Email</p>
        <p class="ttext-gray-700 ttext-sm">
          madella.enterprises.inc@gmail.com
        </p>
      </div>

      <!-- Phone -->
      <div>
        <p class="tfont-medium ttext-pink-600">Contact Number</p>
        <p class="ttext-gray-700 ttext-sm">
          0955-009-0156
        </p>
      </div>
      ...
      <!-- Address -->
      <div>
        <p class="tfont-medium ttext-pink-600">Address</p>
        <p class="ttext-gray-700 ttext-sm">
          Blk 17 Lot 67 Jordan St.<br>
          Hamilton Homes, Bucandala 1<br>
          Imus, Cavite
        </p>
      </div>
    ...
    <!-- Divider -->
    <div class="tw-border-t tw-border-pink-200 tw-my-8"></div>

    <!-- Footer Bottom -->
    <p class="ttext-center ttext-xs ttext-gray-500">
      © 2025 Madella Enterprises Inc. All rights reserved.
    </p>
