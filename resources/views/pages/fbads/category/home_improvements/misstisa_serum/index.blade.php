...
@section('content')
    ...
    <div style="scroll-behavior: smooth;max-width: 480px;" class="tmx-auto" id="body">
            ...
            <div >
                ...
                <div class="">
                    <span class="ttext-sm ttext-white">
                        <i class="fas fa-star" style="color: #ffda00;"></i>
                        <i class="fas fa-star" style="color: #ffda00;"></i>
                        <i class="fas fa-star" style="color: #ffda00;"></i>
                        <i class="fas fa-star" style="color: #ffda00;"></i>
                        <i class="fas fa-star" style="color: #ffda00;"></i>
        ...
        <img src="https://matildasbeauty.com/filemanager/1ceadb566afb4aeea0b91b3ba945703c.webp" class="tw-full tmb-5" alt="top_banner">
        ...
        <div class="tflex tw-full tflex-wrap tjustify-center tpy-3 tpx-3">
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Law-law</b> na Balat</div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Kulubot</b> na Balat</div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Anti-Aging</b> </div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> Naka <b>Banat ng Skin</b> </div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Melasma</b></div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Wrinkles</b></div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Darks Spots</b></div>
            <div class="tw-1/2"><i class="fas fa-check-circle" style="color: #12bc39;"></i> <b>Finelines</b></div>
            <div class="tw-1/2"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i><b> Glass Skin</b></div>
            <div class="tw-1/2 tmb-3"><i class="fas fa-check-circle tmb-2" style="color: #12bc39;"></i> <b>Whitening</b> </div>
        ...
        {{-- <video class="tw-full video-testimonial" controls playsinline webkit-playsinline>
            <source src="https://matildasbeauty.com/filemanager/5a3ab7466f7d401cb2e4a3df4f64a8d4.mp4" type="video/mp4">
            <source src="movie.ogg" type="video/ogg">
        </video> --}}

        <img src="https://matildasbeauty.com/filemanager/1492429088f74fb29a7ff9aa971d5ab9.webp" class="tw-full"  alt="Extreme Anti-aging">
        ...
        <div class="tmx-auto trelative tborder tpx-5 tpb-5">
            ...
            <form action="{{ route('madella_submit') }}" id="form" class="relative" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" id="notif_message" value="{{ $notif_message }}">
                ...
                <div class="tbg-yellow-300 tborder-2 tborder-red-500 tfont-medium tmb-2 tmt-5 tmx-4 trounded ttext-center ttext-red-700">
                    Enjoy our Free Soap & Sunscreen <br> <span class="tfont-extrabold ttext-lg ttext-red-900">Promo until May 20! 2days Left</span> 
                </div>
                ...
                <div class=" tmb-2 tp-3 trelative" >
                    ...
                    <div class="tflex tflex-wrap">
                            ...
                            <div class="tw-full tp-1 tmt-2 trelative">
                                ...
                                @if ($key == 'promo1')
                                    <div class="tabsolute" style="top: -6px; left: 38%%;">
                                        <div class="misstisa-bg tfont-medium tpx-4 trounded ttext-sm ttext-white">
                                            BEST SELLER
                                        </div>
                                    </div>  
                        ...
                        {{-- <div class="tw-full tp-1 tmt-2 trelative">
                            <label class="tblock tborder-2 tpb-12 tpx-3 trounded" style="border-color: #ee2a7b;">
                                <input type="checkbox" id="promo1" name="promo" class="promo" checked="" value="MissTisa_1_SET|499|1pc">
                                <span class="ttext-gray-900 tfont-medium ttext-sm" style="top: 11px;">1 Set MissTisa</span>
                                <span class="tabsolute tfont-medium ttext-grey-900" style="bottom: 10%; left: 10%;color: #000000;">(499/each)</span>
                                <span class="tabsolute misstisa-bg tw-10" style="height: 28px; bottom: 4%; width: 57px; right: 5%; order: 1px solid red; border-top-left-radius: 10px; border-top-right-radius: 10px; ">
                        ...
                        <div class="tw-full tp-1 tmt-2 trelative">
                            <label class="tblock tborder-2 tpb-12 tpx-3 trounded" style="border-color: #ee2a7b;">
                                <input type="checkbox" id="promo2" name="promo" class="promo"  value="MissTisa_2_SET|849|2pcs">
                                <span class="ttext-gray-900 tfont-medium ttext-sm" style="top: 11px;">2 Set MissTisa</span>
                                <span class="tabsolute tfont-medium ttext-grey-900" style="bottom: 10%; left: 10%;color: #000000;">(424/each)</span>
                                <span class="tabsolute misstisa-bg tw-10" style=" height: 28px; bottom: 4%; width: 57px; right: 5%; border: 1px solid red; 
                                    border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                    <span class="tblock ttext-white ttext-center tfont-bold ttext-lg" style="margin-top: 1px;">₱849</span>
                                </span>
                            </label>
                        </div><!-- PROMO 2--> --}}
                    </div>
                ...
                <div class="tw-full ">
                    ...
                    <span  class="misstisa-bg thidden focus:tbg-pink-500 trelative ttext-center tshadow tfont-medium tmt-4 tpy-3 trounded-full ttext-2xl ttext-white tw-full waves-effect z-depth-5" id="loader">
            ...
            <div id="order_success_modal" class="modal trelative">
                ...
                <div class="modal-content" style="padding-bottom: 0px;">
                    ...
                    <div class="tmax-w-md tflex titems-center tjustify-center tmx-auto">
                        ...
                        <div class="tabsolute ttop-0" style="top: -5%; left: 44%%;">
                            <div class="tflex tjustify-center">
                                <img data-src="https://matildasbeauty.com/filemanager/aa4c4107d452449db117a6d4712e0484.png" class="tmt-10 lazy" width="35px" alt="" >
                            </div><!-- LOGO -->
                        </div>
                                ...
                                <div class="tflex titems-between titems-center">
                                    ...
                                    <div class="">
                                        <div class="">
                                            ...
                                            <span class="tmr-3 tmb-2 ttext-xl tfont-medium" style="color: #ee2a7b" id="modal-promo">2pcs</span>
                                        </div>
                                        <div class="">
                                            <span class="tfont-medium tmx-2 ttext-gray-700 ttext-md">Total: </span>
                                            <span class="tmr-3 tmb-2 ttext-xl tfont-medium" style="color: #ee2a7b" >₱<span id="modal-amount"></span></span>
            ...
            <button class="order_now misstisa-bg tabsolute  tbottom-0 tfixed tfont-medium tmb-5 tmt-4 tpy-3 trounded-full ttext-lg ttext-white tw-10/12 waves-effect zoom-in-out-box" 
